const MULTI_FEE_ABI = [
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract IChefIncentivesController', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'contract IChefIncentivesController', name: '_controller', type: 'address' },
    ],
  ...
  {
    inputs: [{ internalType: 'address[]', name: '_minters', type: 'address[]' }],
    name: 'setMinters',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
