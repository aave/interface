/*eslint-disable*/ module.exports = {
  messages: {
    "<0>Ampleforth</0> is an asset affected by rebasing. Visit the <1>documentation</1> or <2>Ampleforth's FAQ</2> to learn more.":
      "<0>Ampleforth</0> is an asset affected by rebasing. Visit the <1>documentation</1> or <2>Ampleforth's FAQ</2> to learn more.",
    'AAVE holders can stake their AAVE in the Safety Module to add more security to the protocol and earn Safety Incentives. In the case of a shortfall event, up to 30% of your stake can be slashed to cover the deficit, providing an additional layer of protection for the protocol.':
      'AAVE holders can stake their AAVE in the Safety Module to add more security to the protocol and earn Safety Incentives. In the case of a shortfall event, up to 30% of your stake can be slashed to cover the deficit, providing an additional layer of protection for the protocol.',
    'ACTIVATE COOLDOWN': 'ACTIVATE COOLDOWN',
    APR: 'APR',
    APY: 'APY',
    'APY type': 'APY type',
    'APY, stable': 'APY, stable',
    'APY, variable': 'APY, variable',
    'AToken supply is not zero': 'AToken supply is not zero',
    ...
    'Aave is a fully decentralized, community governed protocol by the AAVE token-holders. AAVE token-holders collectively discuss, propose, and vote on upgrades to the protocol. AAVE token-holders can either vote themselves on new proposals or delagate to an address of choice. To learn more check out the Governance documentation':
      'Aave is a fully decentralized, community governed protocol by the AAVE token-holders. AAVE token-holders collectively discuss, propose, and vote on upgrades to the protocol. AAVE token-holders can either vote themselves on new proposals or delagate to an address of choice. To learn more check out the Governance documentation',
    'Aave per month': 'Aave per month',
    Account: 'Account',
    'Action cannot be performed because the reserve is frozen':
      'Action cannot be performed because the reserve is frozen',
    'Action cannot be performed because the reserve is paused':
      'Action cannot be performed because the reserve is paused',
    'Action requires an active reserve': 'Action requires an active reserve',
    'Add to wallet': 'Add to wallet',
    'Add {0} to wallet to track your balance.': [
      'Add ',
      ['0'],
      ' to wallet to track your balance.',
    ],
    'Address is not a contract': 'Address is not a contract',
    'All Assets': 'All Assets',
    'All done!': 'All done!',
    'All proposals': 'All proposals',
    'Allowance required action': 'Allowance required action',
    ...
    'Allows you to switch between <0>variable</0> and <1>stable</1> interest rates, where variable rate can increase and decrease depending on the amount of liquidity in the reserve, and stable rate will stay the same for the duration of your loan.':
      'Allows you to switch between <0>variable</0> and <1>stable</1> interest rates, where variable rate can increase and decrease depending on the amount of liquidity in the reserve, and stable rate will stay the same for the duration of your loan.',
    'Already on cooldown': 'Already on cooldown',
    Amount: 'Amount',
    'Amount must be greater than 0': 'Amount must be greater than 0',
    'Ampleforth FAQ': 'Ampleforth FAQ',
    Approval: 'Approval',
    'Approve confirmed': 'Approve confirmed',
    'Approve to continue': 'Approve to continue',
    Approved: 'Approved',
    'Approving {symbol}...': ['Approving ', ['symbol'], '...'],
    'Array parameters that should be equal length are not':
      'Array parameters that should be equal length are not',
    'As per the community vote, ETH borrowing on the Ethereum Market has been paused ahead of the merge to mitigate liquidity risk. <0>Learn more</0>.':
      'As per the community vote, ETH borrowing on the Ethereum Market has been paused ahead of the merge to mitigate liquidity risk. <0>Learn more</0>.',
    Asset: 'Asset',
    'Asset can only be used as collateral in isolation mode only.':
      'Asset can only be used as collateral in isolation mode only.',
    'Asset cannot be used as collateral.': 'Asset cannot be used as collateral.',
    'Asset category': 'Asset category',
    'Asset is not borrowable in isolation mode': 'Asset is not borrowable in isolation mode',
    'Asset is not listed': 'Asset is not listed',
    'Asset supply is limited to a certain amount to reduce protocol exposure to the asset and to help manage risks involved.':
      'Asset supply is limited to a certain amount to reduce protocol exposure to the asset and to help manage risks involved.',
    'Asset to delegate': 'Asset to delegate',
    Assets: 'Assets',
    ...
    'Be careful - You are very close to liquidation. Consider depositing more collateral or paying down some of your borrowed positions':
      'Be careful - You are very close to liquidation. Consider depositing more collateral or paying down some of your borrowed positions',
    'Before supplying': 'Before supplying',
    'Before supplying, you need to approve its usage by the Aave protocol. You can learn more in our <0>FAQ</0>':
      'Before supplying, you need to approve its usage by the Aave protocol. You can learn more in our <0>FAQ</0>',
    'Blocked Address': 'Blocked Address',
    Borrow: 'Borrow',
    'Borrow APY rate': 'Borrow APY rate',
    'Borrow APY, stable': 'Borrow APY, stable',
    'Borrow APY, variable': 'Borrow APY, variable',
    'Borrow and repay in same block is not allowed':
      'Borrow and repay in same block is not allowed',
    'Borrow cap': 'Borrow cap',
    'Borrow cap is exceeded': 'Borrow cap is exceeded',
    'Borrow power used': 'Borrow power used',
    'Borrow {symbol}': ['Borrow ', ['symbol']],
    Borrowed: 'Borrowed',
    'Borrowing is currently unavailable for {0}.': [
      'Borrowing is currently unavailable for ',
      ['0'],
      '.',
    ],
    'Borrowing is not enabled': 'Borrowing is not enabled',
    ...
    'Borrowing is unavailable because you’ve enabled Efficiency Mode (E-Mode) for {0} category. To manage E-Mode categories visit your <0>Dashboard</0>.':
      [
        ...
        ['0'],
        ' category. To manage E-Mode categories visit your <0>Dashboard</0>.',
      ],
    ...
    'Borrowing this amount will reduce your health factor and increase risk of liquidation.':
      'Borrowing this amount will reduce your health factor and increase risk of liquidation.',
    'Borrowing {symbol}': ['Borrowing ', ['symbol']],
    ...
    'Cap reached. Lower supply amount': 'Cap reached. Lower supply amount',
    Claim: 'Claim',
    'Claim AAVE': 'Claim AAVE',
    'Claim all': 'Claim all',
    'Claim all rewards': 'Claim all rewards',
    'Claim {0}': ['Claim ', ['0']],
    'Claimable AAVE': 'Claimable AAVE',
    Claimed: 'Claimed',
    Claiming: 'Claiming',
    Close: 'Close',
    Collateral: 'Collateral',
    'Collateral amount to repay with': 'Collateral amount to repay with',
    ...
    'Cooldown period warning': 'Cooldown period warning',
    'Cooldown time left': 'Cooldown time left',
    'Cooldown to unstake': 'Cooldown to unstake',
    ...
    Dashboard: 'Dashboard',
    Debt: 'Debt',
    'Debt amount to repay': 'Debt amount to repay',
    'Debt ceiling is exceeded': 'Debt ceiling is exceeded',
    'Debt ceiling is not zero': 'Debt ceiling is not zero',
    'Debt limits the amount possible to borrow against this asset by protocol users. Debt ceiling is specific to assets in isolation mode and is denoted in USD.':
      'Debt limits the amount possible to borrow against this asset by protocol users. Debt ceiling is specific to assets in isolation mode and is denoted in USD.',
    'Define Retry with Approval text': 'Define Retry with Approval text',
    Delegate: 'Delegate',
    ...
    'E-Mode increases your LTV for a selected category of assets, meaning that when E-mode is enabled, you will have higher borrowing power over assets of the same E-mode category which are defined by Aave Governance. You can enter E-Mode from your <0>Dashboard</0>. To learn more about E-Mode and applied restrictions in <1>FAQ</1> or <2>Aave V3 Technical Paper</2>.':
      'E-Mode increases your LTV for a selected category of assets, meaning that when E-mode is enabled, you will have higher borrowing power over assets of the same E-mode category which are defined by Aave Governance. You can enter E-Mode from your <0>Dashboard</0>. To learn more about E-Mode and applied restrictions in <1>FAQ</1> or <2>Aave V3 Technical Paper</2>.',
    'Efficiency mode (E-Mode)': 'Efficiency mode (E-Mode)',
    Emode: 'Emode',
    'Enable E-Mode': 'Enable E-Mode',
    'Enable {symbol} as collateral': ['Enable ', ['symbol'], ' as collateral'],
    Enabled: 'Enabled',
    'Enabled in isolation': 'Enabled in isolation',
    'Enabling E-Mode': 'Enabling E-Mode',
    ...
    'Enabling this asset as collateral increases your borrowing power and Health Factor. However, it can get liquidated if your health factor drops below 1.':
      'Enabling this asset as collateral increases your borrowing power and Health Factor. However, it can get liquidated if your health factor drops below 1.',
    English: 'English',
    'Enter ETH address': 'Enter ETH address',
    ...
    'Go Back': 'Go Back',
    'Go back': 'Go back',
    'Go to Balancer Pool': 'Go to Balancer Pool',
    ...
    Hide: 'Hide',
    'I acknowledge the risks involved.': 'I acknowledge the risks involved.',
    'I understand how cooldown ({0}) and unstaking ({1}) work': [
      'I understand how cooldown (',
      ['0'],
      ') and unstaking (',
      ['1'],
      ') work',
    ...
    'If you DO NOT unstake within {0} of unstake window, you will need to activate cooldown process again.':
      [
        'If you DO NOT unstake within ',
        ['0'],
        ' of unstake window, you will need to activate cooldown process again.',
      ],
    ...
    'In Isolation mode, you cannot supply other assets as collateral. A global debt ceiling limits the borrowing power of the isolated asset. To exit isolation mode disable {0} as collateral before borrowing another asset. Read more in our <0>FAQ</0>':
      [
        'In Isolation mode, you cannot supply other assets as collateral. A global debt ceiling limits the borrowing power of the isolated asset. To exit isolation mode disable ',
        ['0'],
        ' as collateral before borrowing another asset. Read more in our <0>FAQ</0>',
      ],
    'Inconsistent flashloan parameters': 'Inconsistent flashloan parameters',
    'Interest rate rebalance conditions were not met':
      'Interest rate rebalance conditions were not met',
    'Invalid amount to burn': 'Invalid amount to burn',
    'Invalid amount to mint': 'Invalid amount to mint',
    'Invalid bridge protocol fee': 'Invalid bridge protocol fee',
    'Invalid expiration': 'Invalid expiration',
    'Invalid flashloan premium': 'Invalid flashloan premium',
    ...
    Links: 'Links',
    'Liquidation <0/> threshold': 'Liquidation <0/> threshold',
    'Liquidation at': 'Liquidation at',
    'Liquidation penalty': 'Liquidation penalty',
    'Liquidation risk': 'Liquidation risk',
    'Liquidation risk parameters': 'Liquidation risk parameters',
    'Liquidation threshold': 'Liquidation threshold',
    'Liquidation value': 'Liquidation value',
    'Ltv validation failed': 'Ltv validation failed',
    MAX: 'MAX',
    Market: 'Market',
    Markets: 'Markets',
    Max: 'Max',
    'Max LTV': 'Max LTV',
    'Max slashing': 'Max slashing',
    'Max slippage rate': 'Max slippage rate',
    ...
    'Maximum amount available to supply is <0/> {0} (<1/>).': [
      'Maximum amount available to supply is <0/> ',
      ['0'],
      ' (<1/>).',
    ],
    ...
    'Net worth': 'Net worth',
    Network: 'Network',
    'Network not supported for this wallet': 'Network not supported for this wallet',
    'New APY': 'New APY',
    'No rewards to claim': 'No rewards to claim',
    'No voting power': 'No voting power',
    None: 'None',
    'Not a valid address': 'Not a valid address',
    'Not enough balance on your wallet': 'Not enough balance on your wallet',
    'Not enough collateral to repay this amount of debt with':
      'Not enough collateral to repay this amount of debt with',
    'Not enough staked balance': 'Not enough staked balance',
    'Not enough voting power to participate in this proposal':
      'Not enough voting power to participate in this proposal',
    'Not reached': 'Not reached',
    'Nothing borrowed yet': 'Nothing borrowed yet',
    'Nothing staked': 'Nothing staked',
    'Nothing supplied yet': 'Nothing supplied yet',
    Notify: 'Notify',
    'Ok, Close': 'Ok, Close',
    ...
    'Please connect your wallet to see your supplies, borrowings, and open positions.':
      'Please connect your wallet to see your supplies, borrowings, and open positions.',
    'Please switch to {networkName}.': ['Please switch to ', ['networkName'], '.'],
    'Please, connect your wallet': 'Please, connect your wallet',
    'Pool addresses provider is not registered': 'Pool addresses provider is not registered',
    ...
    'Rejected connection request': 'Rejected connection request',
    'Remaining debt': 'Remaining debt',
    'Remaining supply': 'Remaining supply',
    Repay: 'Repay',
    'Repay with': 'Repay with',
    'Repay {symbol}': ['Repay ', ['symbol']],
    'Repaying {symbol}': ['Repaying ', ['symbol']],
    'Reserve Size': 'Reserve Size',
    'Reserve factor': 'Reserve factor',
    'Reserve factor is a percentage of interest which goes to a {0} that is controlled by Aave governance to promote ecosystem growth.':
      [
    ...
    'Reserve status & configuration': 'Reserve status & configuration',
    'Retry What?': 'Retry What?',
    'Retry with Approval': 'Retry with Approval',
    'Retry with approval': 'Retry with approval',
    'Review approval tx details': 'Review approval tx details',
    'Review tx': 'Review tx',
    'Review tx details': 'Review tx details',
    'Reward(s) to claim': 'Reward(s) to claim',
    ...
    'Safety of your deposited collateral against the borrowed assets and its underlying value.':
      'Safety of your deposited collateral against the borrowed assets and its underlying value.',
    'Seatbelt report': 'Seatbelt report',
    ...
    'Select token to add': 'Select token to add',
    'Select token to view in block explorer': 'Select token to view in block explorer',
    'Setup notifications about your Health Factor using the Hal app.':
      'Setup notifications about your Health Factor using the Hal app.',
    'Share on twitter': 'Share on twitter',
    Show: 'Show',
    'Show assets with 0 balance': 'Show assets with 0 balance',
    ...
    Spanish: 'Spanish',
    Stable: 'Stable',
    'Stable Interest Type is disabled for this currency':
      'Stable Interest Type is disabled for this currency',
    'Stable borrowing is enabled': 'Stable borrowing is enabled',
    'Stable borrowing is not enabled': 'Stable borrowing is not enabled',
    'Stable debt supply is not zero': 'Stable debt supply is not zero',
    ...
    'Supply cap is exceeded': 'Supply cap is exceeded',
    'Supply cap on target reserve reached. Try lowering the amount.':
      'Supply cap on target reserve reached. Try lowering the amount.',
    'Supply {symbol}': ['Supply ', ['symbol']],
    'Supplying your': 'Supplying your',
    'Supplying {symbol}': ['Supplying ', ['symbol']],
    Swap: 'Swap',
    Swapped: 'Swapped',
    Swapping: 'Swapping',
    'Switch APY type': 'Switch APY type',
    'Switch E-Mode': 'Switch E-Mode',
    'Switch E-Mode category': 'Switch E-Mode category',
    'Switch Network': 'Switch Network',
    'Switch rate': 'Switch rate',
    'Switching E-Mode': 'Switching E-Mode',
    'Switching rate': 'Switching rate',
    'Test Assets': 'Test Assets',
    'Testnet mode': 'Testnet mode',
    'Testnet mode is ON': 'Testnet mode is ON',
    'The % of your total borrowing power used. This is based on the amount of your collateral supplied and the total amount that you can borrow.':
      'The % of your total borrowing power used. This is based on the amount of your collateral supplied and the total amount that you can borrow.',
    'The Aave Balancer Pool Token (ABPT) is a liquidity pool token. You can receive ABPT by depositing a combination of AAVE + ETH in the Balancer liquidity pool. You can then stake your BPT in the Safety Module to secure the protocol and earn Safety Incentives.':
      'The Aave Balancer Pool Token (ABPT) is a liquidity pool token. You can receive ABPT by depositing a combination of AAVE + ETH in the Balancer liquidity pool. You can then stake your BPT in the Safety Module to secure the protocol and earn Safety Incentives.',
    'The Maximum LTV ratio represents the maximum borrowing power of a specific collateral. For example, if a collateral has an LTV of 75%, the user can borrow up to 0.75 worth of ETH in the principal currency for every 1 ETH worth of collateral.':
      'The Maximum LTV ratio represents the maximum borrowing power of a specific collateral. For example, if a collateral has an LTV of 75%, the user can borrow up to 0.75 worth of ETH in the principal currency for every 1 ETH worth of collateral.',
    'The Stable Rate is not enabled for this currency':
      'The Stable Rate is not enabled for this currency',
    'The address of the pool addresses provider is invalid':
      'The address of the pool addresses provider is invalid',
    'The app is running in testnet mode. Learn how it works in':
      'The app is running in testnet mode. Learn how it works in',
    'The caller of the function is not an AToken': 'The caller of the function is not an AToken',
    'The caller of this function must be a pool': 'The caller of this function must be a pool',
    'The collateral balance is 0': 'The collateral balance is 0',
    'The collateral chosen cannot be liquidated': 'The collateral chosen cannot be liquidated',
    'The cooldown period is the time required prior to unstaking your tokens(10 days). You can only withdraw your assets from the Security Module after the cooldown period and within the active the unstake window.<0>Learn more</0>':
      'The cooldown period is the time required prior to unstaking your tokens(10 days). You can only withdraw your assets from the Security Module after the cooldown period and within the active the unstake window.<0>Learn more</0>',
    'The cooldown period is {0}. After {1} of cooldown, you will enter unstake window of {2}. You will continue receiving rewards during cooldown and unstake window.':
      [
        ...
        '. After ',
        ['1'],
        ' of cooldown, you will enter unstake window of ',
        ['2'],
        '. You will continue receiving rewards during cooldown and unstake window.',
      ],
    ...
    'The total amount of your assets denominated in USD that can be used as collateral for borrowing assets.':
      'The total amount of your assets denominated in USD that can be used as collateral for borrowing assets.',
    'The underlying asset cannot be rescued': 'The underlying asset cannot be rescued',
    ...
    'This asset has reached its supply cap. Nothing is available to be supplied from this market.':
      'This asset has reached its supply cap. Nothing is available to be supplied from this market.',
    'This asset is frozen due to an Aave Protocol Governance decision. <0>More details</0>':
      'This asset is frozen due to an Aave Protocol Governance decision. <0>More details</0>',
    'This asset is frozen due to an Aave community decision. <0>More details</0>':
      'This asset is frozen due to an Aave community decision. <0>More details</0>',
    ...
    'This represents the threshold at which a borrow position will be considered undercollateralized and subject to liquidation for each collateral. For example, if a collateral has a liquidation threshold of 80%, it means that the position will be liquidated when the debt value is worth 80% of the collateral value.':
      'This represents the threshold at which a borrow position will be considered undercollateralized and subject to liquidation for each collateral. For example, if a collateral has a liquidation threshold of 80%, it means that the position will be liquidated when the debt value is worth 80% of the collateral value.',
    'Time left to be able to withdraw your staked asset.':
      'Time left to be able to withdraw your staked asset.',
    'Time left to unstake': 'Time left to unstake',
    'Time left until the withdrawal window closes.':
      'Time left until the withdrawal window closes.',
    'To borrow you need to supply any asset to be used as collateral.':
      'To borrow you need to supply any asset to be used as collateral.',
    'To enable E-mode for the {0} category, all borrow positions outside of this cateogry must be closed.':
      [
    ...
    'Type of delegation': 'Type of delegation',
    'UNSTAKE {symbol}': ['UNSTAKE ', ['symbol']],
    'UNSTAKING {symbol}': ['UNSTAKING ', ['symbol']],
    Unavailable: 'Unavailable',
    Unbacked: 'Unbacked',
    'Unbacked mint cap is exceeded': 'Unbacked mint cap is exceeded',
    'Unstake now': 'Unstake now',
    'Unstake window': 'Unstake window',
    'Used as collateral': 'Used as collateral',
    'User cannot withdraw more than the available balance':
      'User cannot withdraw more than the available balance',
    'User did not borrow the specified currency': 'User did not borrow the specified currency',
    ...
    'User does not have outstanding variable rate debt on this reserve':
      'User does not have outstanding variable rate debt on this reserve',
    'User is in isolation mode': 'User is in isolation mode',
    ...
    'VOTE YAE': 'VOTE YAE',
    Variable: 'Variable',
    'Variable debt supply is not zero': 'Variable debt supply is not zero',
    ...
    'When a liquidation occurs, liquidators repay up to 50% of the outstanding borrowed amount on behalf of the borrower. In return, they can buy the collateral at a discount and keep the difference (liquidation penalty) as a bonus.':
      'When a liquidation occurs, liquidators repay up to 50% of the outstanding borrowed amount on behalf of the borrower. In return, they can buy the collateral at a discount and keep the difference (liquidation penalty) as a bonus.',
    'Why do I need to approve?': 'Why do I need to approve?',
    'With a voting power of <0/>': 'With a voting power of <0/>',
    ...
    'Withdrawing this amount will reduce your health factor and increase risk of liquidation.':
      'Withdrawing this amount will reduce your health factor and increase risk of liquidation.',
    'Withdrawing {symbol}': ['Withdrawing ', ['symbol']],
    'Wrong Network': 'Wrong Network',
    YAE: 'YAE',
    'You are entering Isolation mode': 'You are entering Isolation mode',
    ...
    'You can not switch usage as collateral mode for this currency, because it will cause collateral call':
      'You can not switch usage as collateral mode for this currency, because it will cause collateral call',
    'You can not use this currency as collateral': 'You can not use this currency as collateral',
    ...
    'You did not participate in this proposal': 'You did not participate in this proposal',
    'You do not have supplies in this currency': 'You do not have supplies in this currency',
    ...
    'You switched to {0} rate': ['You switched to ', ['0'], ' rate'],
    'You unstake here': 'You unstake here',
    'You voted {0}': ['You voted ', ['0']],
    'You will exit isolation mode and other tokens can now be used as collateral':
      'You will exit isolation mode and other tokens can now be used as collateral',
    'You {action} <0/> {symbol}': ['You ', ['action'], ' <0/> ', ['symbol']],
    ...
    'Your health factor and loan to value determine the assurance of your collateral. To avoid liquidations you can supply more collateral or repay borrow positions.':
      'Your health factor and loan to value determine the assurance of your collateral. To avoid liquidations you can supply more collateral or repay borrow positions.',
    'Your info': 'Your info',
    'Your reward balance is 0': 'Your reward balance is 0',
    'Your supplies': 'Your supplies',
    'Your voting info': 'Your voting info',
    'Your {networkName} wallet is empty. Get free test assets at': [
      'Your ',
      ['networkName'],
      ' wallet is empty. Get free test assets at',
    ],
    'Your {networkName} wallet is empty. Get free test {0} at': [
      'Your ',
      ['networkName'],
      ' wallet is empty. Get free test ',
      ['0'],
      ' at',
    ],
    'Your {networkName} wallet is empty. Purchase or transfer assets': [
      'Your ',
      ['networkName'],
      ' wallet is empty. Purchase or transfer assets',
    ],
    'Zero address not valid': 'Zero address not valid',
    assets: 'assets',
    'blocked activities': 'blocked activities',
    'copy the error': 'copy the error',
    documentation: 'documentation',
    ends: 'ends',
    'here.': 'here.',
    'is an asset affected by rebasing. Visit the': 'is an asset affected by rebasing. Visit the',
    of: 'of',
    on: 'on',
    or: 'or',
    'or use <0>{0}</0> to transfer your ETH assets.': [
      'or use <0>',
      ['0'],
      '</0> to transfer your ETH assets.',
    ],
    ...
    'tokens is not the same as staking them. If you wish to stake your':
      'tokens is not the same as staking them. If you wish to stake your',
    'tokens, please go to the': 'tokens, please go to the',
    withdrew: 'withdrew',
    '{0}': [['0']],
    '{0} Balance': [['0'], ' Balance'],
    '{0} Faucet': [['0'], ' Faucet'],
