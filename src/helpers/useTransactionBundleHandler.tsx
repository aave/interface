...
export const useTransactionBundleHandler = ({
    ...
    const [generateSignedAction, setGenerateSignedAction] = useState<({ signatures, }: SignedActionRequest) => Promise<PopulatedTransaction>>();
                ...
                return handleGetBundle()
                    .then(async (bundle) => {
                        ...
                        if (approvalTransactions.length > 0 && preferPermit) {
                            ...
                            setUsePermit(false);
                            setApprovalTxes(approvalTransactions);
                            setSignatureRequests(bundle.signatureRequests);
                            ...
                            if (actionTxGas) {
                                gasLimit += Number(formatUnits(actionTxGas, 18))
                            }
