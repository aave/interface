...
import { MeritApyGraph, MeritApyDataItem, MeritApyPlaceholderChart } from './MeritApyGraph';
    ...
    return (
        <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{ flex: 1, minHeight: CHART_HEIGHT, width: '100%' }}>
                ...
                {error && graphError}
                {!loading && !error && <StableChart data={data} lineColor={lineColor} showAverage={showAverage} />}
            </Box>
        </Box>
    );
};