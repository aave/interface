...
export const AmountStakedItem = ({ stakeData }: { stakeData: MergedStakeData }) => {
  const { openUmbrellaStakeCooldown } = useModalContext();
    ...
    <Stack direction="column" alignItems="center" justifyContent="center">
      ...
      <Stack direction="column" alignItems="center" justifyContent="center" minWidth={150}>
        <Button
          ...
          onClick={() => openUmbrellaStakeCooldown(stakeData.stakeToken, stakeData.iconSymbol)}
        >
        ...
        {isCooldownActive && (
          <Stack width={'100%'} direction="row" alignItems="center" justifyContent="space-between">
            ...
            <Typography variant="helperText" sx={{ display: 'inline-flex', gap: 1 }}>
