  ...
  return (
    <>
      <BasicModal open={open} setOpen={close}>
        ...
        <Typography sx={{ my: 6 }}>
          <Trans>
            The Mooncake Finance Balancer Pool Token (ABPT) is a liquidity pool token. You can
            receive ABPT by depositing a combination of MCAKE + ETH in the Balancer liquidity pool.
            You can then stake your BPT in the Safety Module to secure the protocol and earn Safety
            Incentives.
          </Trans>
        </Typography>
        <Button
