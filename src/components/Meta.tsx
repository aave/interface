...
export function Meta({ title, description, imageUrl, timestamp }: MetaProps) {
  return (
    <Head>
      <title>Mooncake Finance - {title}</title>
      <meta name="description" content={description} key="description" />
      <meta property="og:title" content={`Mooncake Finance - ${title}`} key="title" />
      ...
      <meta name="apple-mobile-web-app-title" content={`Mooncake Finance`} />
