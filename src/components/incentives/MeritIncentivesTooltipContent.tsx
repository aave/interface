...
export const MeritIncentivesTooltipContent = ({
  ...
  return meritIncentives?.action === MeritAction.CELO_SUPPLY_USDT ? (
    <Box
      sx={{
        display: 'flex',
    ...
    >
      ...
      <Typography variant="caption" color="text.primary" fontSize={13}>
        <Trans>Eligible for Merit program and Boosted Yield via Self.</Trans>
      </Typography>
            ...
            caption={
              ...
              >
                ...
                <Typography variant={typographyVariant}>
                  {meritIncentivesFormatted.symbol}
                </Typography>
              </Box>
            }
            width="100%"
