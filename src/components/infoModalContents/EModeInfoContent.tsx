...
export const EModeInfoContent = () => {
  return (
    <InfoContentWrapper caption={<Trans>Efficiency Mode(E-Mode)</Trans>}>
      <Typography>
        <Trans>
          E-Mode increases your borrowing power for a selected category of assets up to 99%. Enabling E-mode will restrict the assets you can borrow against your collateral to the ones specified in the selected E-mode.
          Please visit out
