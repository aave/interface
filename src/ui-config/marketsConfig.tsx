...
export const marketsData: {
  ...
  [CustomMarket.proto_mainnet_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Ethereum.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_base_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Base.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_arbitrum_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Arbitrum.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_avalanche_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Avalanche.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_optimism_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Optimism.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_polygon_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Polygon.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_metis_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Metis.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_gnosis_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Gnosis.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_bnb_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3BNB.UI_POOL_DATA_PROVIDER,
  ...
  [CustomMarket.proto_scroll_v3]: {
    ...
    addresses: {
      ...
      V3_1_UI_POOL_DATA_PROVIDER: AaveV3Scroll.UI_POOL_DATA_PROVIDER,
