...
export const marketsData: {
  ...
  [CustomMarket.bsc_testnet_v3]: {
    ...
    addresses: {
      ...
      LENDING_POOL:
        process.env.NEXT_PUBLIC_MANEKI_LENDING_POOL || '0x11d92458ce918223Ff2aC0Fd1a624949a309ee0e',
      WETH_GATEWAY:
        process.env.NEXT_PUBLIC_MANEKI_WETH_GATEWAY || '0x362E3D6dC35a67C83efBAD559Dcf08c9c3785fa8',
      SWAP_COLLATERAL_ADAPTER: '',
      REPAY_WITH_COLLATERAL_ADAPTER: '',
      FAUCET: '',
      PERMISSION_MANAGER: '',
      WALLET_BALANCE_PROVIDER:
        ...
        '0x8748EEc2A6Aa5f56688326D8F7A6371C8D8651b4',
      L2_ENCODER: '',
      UI_POOL_DATA_PROVIDER:
        process.env.NEXT_PUBLIC_MANEKI_UI_POOL_DATA_PROVIDER ||
        '0x13B39Ea3BE0B37271159cb83219d262D19afa28e',
      UI_INCENTIVE_DATA_PROVIDER:
        process.env.NEXT_PUBLIC_MANEKI_UI_INCENTIVE_DATA_PROVIDER ||
        '0x4cF8fF5A9b660405c0353937F500f8333D99Acd7',
      COLLECTOR:
