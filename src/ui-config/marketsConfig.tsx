...
export const marketsData: {
  ...
  [CustomMarket.bsc_testnet_v3]: {
    ...
    addresses: {
      ...
      LENDING_POOL:
        process.env.NEXT_PUBLIC_MANEKI_LENDING_POOL || '0x26b0A7fEa02F55dC7D38913b5C55519Be171895A',
      WETH_GATEWAY:
        process.env.NEXT_PUBLIC_MANEKI_WETH_GATEWAY || '0xc4378Ad54224AcCFD31E3f1d0C3FDd50Afa7C327',
      SWAP_COLLATERAL_ADAPTER: '',
      REPAY_WITH_COLLATERAL_ADAPTER: '',
      FAUCET: '',
      PERMISSION_MANAGER: '',
      WALLET_BALANCE_PROVIDER:
        process.env.NEXT_PUBLIC_MANEKI_WALLET_BALANCE_PROVIDER ||
        '0x54e7a16fC56F06819318652e2234728bE1f6fdBd',
      L2_ENCODER: '',
      UI_POOL_DATA_PROVIDER:
        process.env.NEXT_PUBLIC_MANEKI_UI_POOL_DATA_PROVIDER ||
        '0xaDF14a04A0bA4AB76fA57b3923dd100986E1B50f',
      UI_INCENTIVE_DATA_PROVIDER:
        process.env.NEXT_PUBLIC_MANEKI_UI_INCENTIVE_DATA_PROVIDER ||
        '0x17A26446addc32C7c19F00aCe93Dd0c6026d62DF',
      COLLECTOR:
        process.env.NEXT_PUBLIC_MANEKI_COLLECTOR || '0x737c57442E90A5597a50620C864Ab916654f755E',
      V3_MIGRATOR: '',
    },
  },
  /*
