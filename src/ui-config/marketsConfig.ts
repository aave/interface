...
export const marketsData: {
  ...
  [CustomMarket.proto_kovan_v3]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER:
        "0xE5fb10674949D25c8df1aD5B064554475D800aBE".toLowerCase(),
  ...
  [CustomMarket.proto_eth_rinkeby_v3]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER:
        "0xf4C5dF4e991C9d0E59723E4eB872B48f3E44EDc9".toLowerCase(),
  ...
  [CustomMarket.proto_mumbai]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER:
        "0x178113104fEcbcD7fF8669a0150721e231F0FD4B".toLowerCase(),
  ...
  [CustomMarket.proto_matic]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER:
        "0xd05e3E715d945B59290df0ae8eF85c1BdB684744".toLowerCase(),
  ...
  [CustomMarket.proto_fuji]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER:
        "0x7fdC1FdF79BE3309bf82f4abdAD9f111A6590C0f".toLowerCase(),
  ...
  [CustomMarket.proto_avalanche]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER:
        "0xb6A86025F0FE1862B372cb0ca18CE3EDe02A318f".toLowerCase(),
  ...
  [CustomMarket.proto_arbitrum_rinkeby]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER:
        "0xf89a5A208e3c4D34A6d4CefA5D1de2D9D003ae92".toLowerCase(),
