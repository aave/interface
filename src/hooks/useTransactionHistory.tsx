...
export const useTransactionHistory = () => {
    ...
    const fetchTransactionHistory = async ({ account, subgraphUrl, first, skip, v3 }: TransactionHistoryParams) => {
        const requestBody = {
    ...
    return useQuery({
        queryFn: () => fetchTransactionHistory({ account, subgraphUrl: currentMarketData.subgraphUrl ?? '', first: 100, skip: 0, v3: !!currentMarketData.v3 }),
