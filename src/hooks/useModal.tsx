...
export enum ModalType {
  ...
  DebtSwitch = 'DebtSwitch',
  GovDelegation = 'GovDelegation',
  GovVote = 'GovVote',
  V3Migration = 'V3Migration',
  RevokeGovDelegation = 'RevokeGovDelegation',
  StakeRewardsClaimRestake = 'StakeRewardsClaimRestake',
  Switch = 'Switch',
  StakingMigrate = 'StakingMigrate',
  GovRepresentatives = 'GovRepresentatives',
  Bridge = 'Bridge',
  ReadMode = 'ReadMode',
  Umbrella = 'Umbrella',
  UmbrellaStakeCooldown = 'UmbrellaStakeCooldown',
  UmbrellaClaim = 'UmbrellaClaim',
  UmbrellaClaimAll = 'UmbrellaClaimAll',
  UmbrellaUnstake = 'UmbrellaUnstake',
  SavingsGhoDeposit = 'SavingsGhoDeposit',
  SavingsGhoWithdraw = 'SavingsGhoWithdraw',
}
