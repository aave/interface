...
export const figmaLight = {
  ...
  'fg-icon': '#A8A8A8',
  // Disclosure chevron on the settings menu's drill-in rows (Language, Theme). Mode-agnostic like
  // `fg-icon`: the spec gives #8F8E8E in BOTH modes, which is a shade lighter than light `fg-3`
  // (#7d7d7d) and identical to dark `fg-3`.
  'fg-chevron': '#8f8e8e',
