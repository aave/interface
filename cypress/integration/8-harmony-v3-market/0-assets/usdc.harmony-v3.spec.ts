...
const testData = {
  ...
  testCases: {
    borrow: [
      {
        asset: assets.harmonyMarket.USDC,
        amount: 25,
    ...
    repay: [
      ...
      },
      {
        asset: assets.harmonyMarket.USDC,
        apyType: constants.apyType.stable,
        repayableAsset: assets.harmonyMarket.aUSDC,
        amount: 2,
        hasApproval: true,
        repayOption: constants.repayType.default,
      },
    ...
    finalDashboard: [
      {
        ...
        wrapped: assets.harmonyMarket.USDC.wrapped,
        amount: 7.0,
...
describe('USDC INTEGRATION SPEC, HARMONY V3 MARKET', () => {
